...
void tanganKananroro(){
  tanganKananAtasroro();
  tanganKananBawahroro();
  pergelanganKananroro();
}
void kepalaroro(){
  mukaroro();
  mataroro();
